  ...
  const convert = () => {
    ...
    switch (fromUnit) {
      case 'g':
        ...
        break;
      case 'lbs':
        inKg = numValue * 0.45359237;
        break;
      case 'oz':
        inKg = numValue * 0.0283495;
        break;
      default:
        inKg = numValue;
    }
    ...
    switch (toUnit) {
      case 'g':
        finalResult = inKg * 1000;
        break;
      case 'lbs':
        finalResult = inKg / 0.45359237;
        break;
      case 'oz':
        finalResult = inKg / 0.0283495;
        break;
      default:
        finalResult = inKg;
    }
  ...
  return (
    <div className="max-w-md mx-auto">
      <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-lg">
        <h2 className="text-2xl font-bold mb-6 text-gray-800 dark:text-white">Weight Converter</h2>
